...
var edit_phone = document.getElementById('phone');
var edit_btn = document.getElementById('updateBook');
var editString = window.location.search;
var editParams = new URLSearchParams(editString);
var geturlparam = editParams.get('id');
